...
# "Ngày báo cáo" D = từ CRM_DAY_START_HOUR hôm trước (D-1) đến CRM_DAY_END_HOUR hôm D.
# Mặc định 18h -> 18h: trọn 24 tiếng, không có khoảng chết.
CRM_DAY_START_HOUR = int(_get("CRM_DAY_START_HOUR", "18") or "18")
